{
    ...
    "data": [
        ...
        "views/layout.xml",
        "views/footer.xml",
        "views/snippets/quiz_home.xml",
        "views/snippets/quiz_play.xml",
    ...
    "assets": {
        "web.assets_frontend": [
            ...
            "theme_ninja_quiz/static/src/js/snippets/quiz_home.js",
            "theme_ninja_quiz/static/src/js/snippets/quiz_play.js",
